<template>
  <div id="Login">
    <section class="login-section">
      <h1>please login to get access into the platform</h1>
      <div class="login-content">
        <div class="text-login">
          <img class="google-img" src="../assets/google.png" alt="" />
          <a class="login-btn" @click="login" target="_blank">
    ...
    login() {
      ...
      firebase
        ...
        .then((result) => {
          ...
          this.$store.state.text = "text changed;";
...
#Login {
  ...
  background: linear-gradient(rgba(255, 45, 74, 0.5), rgba(0, 0, 0, 0.5)),
